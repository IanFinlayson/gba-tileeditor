...
// these are DIFFERENT for AFFINE backgrounds!!!
// ALSO they are fixed point numbers!!!
#define SCROLLX *(volatile unsigned int*)0x4000028
#define SCROLLY *(volatile unsigned int*)0x400002c
